"""
O módulo nn, que utilizamos para criar uma camada linear, também contém as principais funções de ativação.
"""
# fazendom uma função de ativação apenas com pytorch
